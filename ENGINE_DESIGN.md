...
- **Inventory & Progression**: The engine supports a full inventory system (pickup, use, drop, stacking) and a player progression system (XP and leveling).[src/game/progression.ts:L1-L59](./src/game/progression.ts#L1-L59)[src/game/updateState.ts:L1-L270](./src/game/updateState.ts#L1-L270)
